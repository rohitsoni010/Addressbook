...
<br>
  ...
  <center>
    ...
    <form method="post">
                ...
                <thead>
                        <tr>
                            ...
                            <th>Status </th>
                            <th>Relation</th>
                            <th colspan='4'> Gallery Options </th>
                            <tr  height = 0px></tr>
    ...
    while ($row = mysqli_fetch_array($run_query )) {
        ...
        echo "<td>$status</td>";
        echo "<td>$relation</td>";
        echo "<td align=centre><button><a href='galleryview.php?id=".$rid."' >View Gallery</a></button><td>";
        echo "<td align=centre><button><a href='galleryadd.php?id=".$rid."'>Add to Gallery</a></button><td>";
